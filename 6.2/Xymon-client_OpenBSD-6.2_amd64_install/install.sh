...
cp ./xymon_client_4.3.28_openbsd-6.2_amd64_compiled.tar.gz /
cd /
tar xzf xymon_client_4.3.28_openbsd-6.2_amd64_compiled.tar.gz
...
rm /xymon_client_4.3.28_openbsd-6.2_amd64_compiled.tar.gz
